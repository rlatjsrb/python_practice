...
# 다이어트약 복용 전 몸무게
before <- c(68.12,56.94,57.36,54.64,64.33,48.49,68.72,56.19,61.6,58.75,67.31,
            49.7,58.39,58.08,65.67,54.5,59.14,55.61,60.21,62.91)
# 다이어트약 복용 5개월 후 몸무게
...
# 대응표본이어서 paired = TRUE 옵션 사용
# 단측 검정으로 before 데이터가 더 큰지 검정하므로 alternative = 'greater' 사용
...
# 독립표본이어서 paired = FALSE 옵션 사용
# 양측 검정이므로 alternative = 'two.sided' 사용
# Seoul 데이터와 Busan 데이터의 분산이 동일하지 않아 var.equal - FALSE 사용
